                  ...
                  <?php
                    ...
                    if($agen->num_rows() > 0){
                      foreach ($agen->result() as $agen):
                        ...
                        ($agen->status == "A") ?
                            $status = "<div class=\"btn btn-primary btn-sm\" role=\"alert\"><i class=\"fa fa-check\"></i> Aktif</div>" :
                            $status = "<div class=\"btn btn-danger btn-sm\" role=\"alert\"><i class=\"fa fa-close\"></i> Tidak Aktif</div>" ;
                        echo "
                        <div class=\"card border-primary m-2\" style=\"width: 19rem;\">
                          ...
                          <p class=\"card-text\">
                            <table width=\"100%\"class=\"table table-striped\">
                              ...
                              <tr>
                                <td width=\"40%\">Status Agen</td>
                                <td width=\"10%\">:</td>
                                <td width=\"50%\">".$status."</td>
                              </tr>
                              <tr>
                                <td width=\"40%\">Jumlah Nasabah (Tersalurkan)</td>
                                <td width=\"10%\">:</td>
                                <td width=\"50%\">".$jml_nasabah." Orang</td>
                              </tr>
                              <tr>
                                <td width=\"40%\">Jumlah Nasabah (Ditolak)</td>
                                <td width=\"10%\">:</td>
